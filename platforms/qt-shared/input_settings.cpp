...
InputSettings::InputSettings(GLFrame* gl_frame)
{
    ...
    widget_.lineEditUp->installEventFilter(this);
    widget_.lineEditRight->installEventFilter(this);
    widget_.lineEditDown->installEventFilter(this);
    widget_.lineEditLeft->installEventFilter(this);
    widget_.lineEditA->installEventFilter(this);
    widget_.lineEditB->installEventFilter(this);
    widget_.lineEditStart->installEventFilter(this);
    widget_.lineEditSelect->installEventFilter(this);
}
...
void InputSettings::RestoreKeys()
{
    ...
    widget_.lineEditUp->setText(keys_[0].text);
    widget_.lineEditRight->setText(keys_[1].text);
    widget_.lineEditDown->setText(keys_[2].text);
    widget_.lineEditLeft->setText(keys_[3].text);
    widget_.lineEditA->setText(keys_[4].text);
    widget_.lineEditB->setText(keys_[5].text);
    widget_.lineEditStart->setText(keys_[6].text);
    widget_.lineEditSelect->setText(keys_[7].text);
    gl_frame_->ResumeRenderThread();
    this->reject();
}
...
void InputSettings::SaveSettings(QSettings& settings)
{
    ...
    settings.setValue("KeySELECT", keys_[7].keyCode);
    ...
    settings.setValue("KeyNameSELECT", keys_[7].text);
}
...
void InputSettings::LoadSettings(QSettings& settings)
{
    ...
    keys_[7].keyCode = settings.value("KeySELECT", Qt::Key_Return).toInt();
    ...
    strcpy(keys_[7].text, settings.value("KeyNameSELECT", "SPACE").toString().toLatin1().constData());
    ...
    widget_.lineEditB->setText(keys_[5].text);
    widget_.lineEditStart->setText(keys_[6].text);
    widget_.lineEditStart->setText(keys_[7].text);
